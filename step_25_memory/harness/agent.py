"""Step 24 - a tool result can carry a picture. After the results of one reply
are appended, every `[[image:PATH]]` marker they carried becomes a user
message that shows the model the PNG. The marker itself is stripped.
"""
