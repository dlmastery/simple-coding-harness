...
subagent ever sees it. The rest is step 36: the agent tools join the
...
SERIAL = {"task", "browse", "submit_plan", "ask_user", "handoff_to", "finish", *browser.TOOLS, *computer.COMPUTER_TOOLS}
