...
| 10 Sep | [Negative Self-Distillation: Learning to Reason by Avoiding Flaws](https://arxiv.org/abs/2609.11699) | A distinct form of model self-training; useful for the self-* comparison | Abstract and metadata checked |
| 9 Sep; v2 10 Sep | [ADMET-EvO: a self-evolving scientific agent for sustained research across heterogeneous tasks](https://arxiv.org/abs/2609.10121) | Evidence-guided experiment selection and retention of inconclusive results | Abstract and metadata checked |
