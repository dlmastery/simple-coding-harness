...
def final(root):
    ...
    (root / 'experiment/PROGRESS.md').write_text('# Closed experiment\n\nEight charged fits. Terminal evaluation completed once. FINAL-LOCK.md prevents new fits; the frozen external decision is unchanged.\n', encoding='utf-8')
