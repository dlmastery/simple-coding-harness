...
The first priority was individual infographics for early feedback. That production checkpoint is complete: maps, source index, guided course map, location cues, introduction, and all 101 individual figures are published. Current work verifies bounded activities and corrects their README examples, source interpretations, skills, and captions where evidence requires it. Continue the published-rendering review alongside that work. Do not mistake a shared overview or technical schematic for an individual illustration, or an authored figure for an executed activity.
