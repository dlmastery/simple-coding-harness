...
All 101 labs have an editorial pass, worked examples, output guidance, recovery, quizzes, and transitions. All retain precise technical diagrams. Eleven selected generated illustrations now cover the overview, leakage, bounded state, graph/ontology distinction, meta-harness, self-* comparison, inherited improver, RSIAgent memory, Dream-RSI replay, ScienceBuddy pairs, and compute contracts. These counts do not establish uniform visual quality or tested activities.
...
| Work | Next material |
|---|---|
| Named research methods | AIDE²: task search, researcher revision, and separate ignition question; ScientistTwo: hypothesis, screening, experiment, ablation, and review |
