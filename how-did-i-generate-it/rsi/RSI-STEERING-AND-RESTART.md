...
Use the built-in image-generation tool under that approval. It returns an image and output hint, but no model identifier; do not label its outputs Imagen-generated. Four illustrations now accompany the main README and labs 00.01, 02.02, 06.02, and 09.01. All seven generated versions, exact prompts, and review notes are retained in [the gallery](visuals/generated/README.md). The 101 Mermaid technical schematics remain companions. Continue the remaining raster set and rendered-page review; do not ask for provider approval again.
