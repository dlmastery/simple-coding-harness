...
const topics=[
  ...
  ["07.01","Correcting an answer does not rewrite the procedure"],
  ["07.02","A convincing explanation still needs a test"],
  ["07.03","Saved, used, and useful need different evidence"],
  ["07.04","Improve the task skill while its improver stays fixed"],
  ["07.05","Work can move without workers getting better"],
  ["07.06","A collective pattern is not automatically a benefit"],
  ["07.07","Self-play changes the policy, not necessarily the trainer"],
  ['07.08','Similar words, different changes'],
  ["08.01","Keep every planned pair, not just the best run"],
  ["08.02","Freeze the choice before you reveal the final score"],
  ["08.03","Count the work that produced the retained result"],
  ["08.04","Test the combination, not only its parts"],
  ["08.05","Freeze the procedure before testing a new task"],
  ["08.06","Reject a win created by changing the metric"],
