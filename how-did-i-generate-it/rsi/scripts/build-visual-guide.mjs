...
const topics=[
  ...
  ["03.01","An arrow names something the next action needs"],
  ["03.02","Missing evidence needs its own route"],
  ["03.03","Two passes must describe the same candidate"],
  ["03.04","Repair the artifact while keeping the rule fixed"],
  ["03.05","Rerun the work whose inputs changed"],
  ["03.06","The plan, the files, and the events answer different questions"],
  ['04.01','Name the object before you claim it improved'],
  ['04.02','Workflow and domain meaning'],
  ['04.03','Pair each rule with a case that breaks it'],
  ['04.04','Changing the record does not repair an invalid run'],
  ['04.05','A new prediction time creates a new task contract'],
  ["05.01","Give each component a job you can check"],
  ["05.02","Choose the procedure that matches the question"],
  ["05.03","A useful summary keeps the right authority"],
  ['05.04','Save the state. Check the handoff.'],
  ["05.05","One removed check can hide behind another"],
  ["06.01","Define the experiment before you generate the harness"],
  ['06.02','The builder and the system it builds'],
  ["06.03","A requirement needs more than a sentence"],
  ["06.04","A pass belongs to a specific request"],
  ["06.05","Change the task brief while the builder stays fixed"],
  ["06.06","Repeat execution before you claim reproducibility"],
