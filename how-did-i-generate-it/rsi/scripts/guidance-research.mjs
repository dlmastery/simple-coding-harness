...
export const researchGuidance = {
  ...
  '10.17': {
    ...
    outputs:[['Accumulated trace review','Uses existing update traces with their actual updater identities and outcomes.'],['META-SKILL-v1.md and schedule','Record the one updater edit, its intended effect, overhead, and limit.'],['Later matched improvement record','Shows inheritance, behavior under each updater, at most four fits, and separate structure/benefit conclusions.']],
