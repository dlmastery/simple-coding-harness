...
out = repo.parent / "rsi-work-2026-09-21-three-views-v2"
if out.exists():
...
arrow(ax,(8.9,2.05),(9.45,2.05),"pass")
...
box(ax,.4,1.25,3.9,1.85,"Pinned task data","rsi/examples/bike-demand/\nsource/hour.csv\nselection rows and source targets", "green")
