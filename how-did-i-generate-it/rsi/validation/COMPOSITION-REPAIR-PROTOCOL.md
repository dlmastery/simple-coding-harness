...
## Post-run source review

After the four declared fits, inspection found that the original operator
also capped unlimited trees on a nominally higher-capacity branch. A separate
no-fit source revision preserves unlimited depth above factor one. Its 420
construction checks and ten extra checks pass, including identical constructors
for the two earlier factor-0.3 revised fits. No fifth attempt was added.
The archive retains the original protocol snapshot, failed first preflight,
actual fitted source and later source separately. See the
[repair evidence](../../../rsi/evidence/2026-09-22/composition-repair/README.md).
