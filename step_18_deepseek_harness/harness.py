...
Two halves here:
  ...
  plugin/             our policy as a dsh plugin: a `tools/pre-execute` gate
                      running the step 12 rules, mounted through a patch file
...
# --- step 10: sessions are JSONL logs under the harness home ----------------------
...
# --- step 5: notifications are the event stream; we pick what to show -------------
