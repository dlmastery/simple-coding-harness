"""Step 24 - replay draws an image message by its caption. The rest is step 21:
...
class UI:
    ...
    def banner(self, sandbox_name="none"):
        ...
        self.console.print(Padding(Text(f"sandbox: {sandbox_name}  ·  /sessions  /rewind  ·  alt-enter for a newline  ·  {LEAVE}", style=MUTED), (0, 0, 0, 2)))
