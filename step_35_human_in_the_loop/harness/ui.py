...
class UI:
    ...
    def banner(self, sandbox_name="none", mode="act"):
        ...
        self.console.print(Padding(Text(f"mode: {mode}  ·  sandbox: {sandbox_name}  ·  /plan  /act  /init  /sessions  /rewind  /undo  ·  alt-enter for a newline  ·  ctrl-c to steer  ·  ctrl-d to exit", style=MUTED), (0, 0, 0, 2)))
