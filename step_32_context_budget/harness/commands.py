"""Step 32 - /context prints the context budget: one bar per category and
the share of the window in use. The rest is step 31: /init writes an
AGENTS.md for the working directory and /instructions lists the
instruction files the system prompt carries.
"""
