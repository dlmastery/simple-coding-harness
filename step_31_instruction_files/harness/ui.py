"""Step 31 - confirm() asks `approve? (y/n)` before a command writes a
file, the way approve_plan() asks about a plan. The rest is step 30:
eval_table() draws the result of an eval run.
"""
