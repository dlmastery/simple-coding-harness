"""Step 02 - the component catalog, in two shapes.

Static mode (step 01) keeps its three tools. Declarative mode adds a catalog
of eight components and lets the model write a whole layout as JSON. The
JSON Schema the layout is validated against is built from the catalog, in
two shapes:
