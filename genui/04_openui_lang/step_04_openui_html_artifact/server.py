"""Step 04 - the server: static files plus one streaming route.
...
@openuidev/react-lang as the text arrives. The artifact document is just
part of that text: no second endpoint, no tool call.
"""
...
LAST = {"program": "", "usage": {}}  # the most recent complete program, for the demo
