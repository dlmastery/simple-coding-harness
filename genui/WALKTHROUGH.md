# Recorded GenUI walkthrough

[Current course introduction](README.md) · [Original version and backup](../how-did-i-generate-it/genui/backups/README.md)

This preserves the original narrative and recorded demos from commit 0d10b486. Timings, screenshots and provider behavior are historical observations. Use current lesson files for execution; old cost comparisons are not universal guarantees.
