"""Generative UI step 01 - tools gain render_ui: a spec in, a picture out on
every surface that is listening.
"""

import json
import subprocess

from . import history, sandbox, web
from .genui import RENDER_UI_SCHEMA, validate
