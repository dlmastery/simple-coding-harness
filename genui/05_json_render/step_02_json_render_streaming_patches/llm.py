...
def stream_text(system_prompt, user_prompt):
    """One streaming call. No JSON mode: the reply is JSONL, one patch per line,
    and JSON mode would insist on a single object."""
