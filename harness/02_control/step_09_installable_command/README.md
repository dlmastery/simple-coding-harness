...
You are in **Keep actions within limits**. Start with [setup](../../START-HERE.md) if you opened this lesson directly. Previous: [Stage 8 - Sessions, slash commands and rewind](../../01_foundations/step_08_sessions_rewind/README.md). Next: [Stage 10 - Todos](../step_10_todos/README.md).
