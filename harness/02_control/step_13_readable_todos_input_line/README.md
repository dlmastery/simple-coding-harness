...
Does a clearer todo display improve the model's underlying plan by itself?
...
Not necessarily. The display helps people inspect state. Judge the plan through its actions and results, separately from presentation.
