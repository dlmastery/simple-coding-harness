...
A summary omits a constraint. Can later work safely assume it still applies from memory?
...
The constraint must remain available or be restored before the affected action. Compaction can lose information; inspect its preserved content.
