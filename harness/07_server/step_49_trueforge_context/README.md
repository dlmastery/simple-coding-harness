...
You are in **Move the loop behind a service**. Start with [setup](../../START-HERE.md) if you opened this lesson directly. Previous: [Step 48 - Sandbox, skills and code mode](../step_48_trueforge_sandbox_skills/README.md). Next: [Step 50 - Subagents, sessions and evaluation on TrueForge](../step_50_trueforge_subagents_eval/README.md).
...
```bash
cd harness/07_server/step_49_trueforge_context
...
The service stops a turn because of a limit. What should the client preserve?
...
The stopping reason, partial output and relevant state. A stopped turn must not be reported as a successful task merely because it returned text.
