...
You are in **Move the loop behind a service**. Start with [setup](../../START-HERE.md) if you opened this lesson directly. Previous: [Step 47 - Tools and permissions as MCP](../step_47_trueforge_tools_mcp/README.md). Next: [Step 49 - Context, questions and stop conditions on TrueForge](../step_49_trueforge_context/README.md).
...
cd harness/07_server/step_48_trueforge_sandbox_skills
