...
You are in **Move the loop behind a service**. Start with [setup](../../START-HERE.md) if you opened this lesson directly. Previous: [Step 50 - Subagents, sessions and evaluation on TrueForge](../step_50_trueforge_subagents_eval/README.md). This is the final comparison lesson.
...
```bash
cd harness/07_server/step_51_trueforge_comparison
python demo.py
