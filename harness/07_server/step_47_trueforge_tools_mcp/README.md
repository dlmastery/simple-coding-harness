...
Does moving tools behind an MCP server remove the need for permissions?
...
No. It changes where operations are exposed and executed. Identify which component authorizes each action and how refusal is reported.
