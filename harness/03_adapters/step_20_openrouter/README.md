...
You are in **Separate the harness from its provider**. Start with [setup](../../START-HERE.md) if you opened this lesson directly. Previous: [Step 19 - The same harness on DeepSeek Harness (dsh)](../step_19_deepseek_harness/README.md). Next: [Step 21 - Streaming and headless mode](../../04_tools/step_21_streaming_headless/README.md).
...
```bash
diff -r ../../02_control/step_15_subagents/harness harness
```
