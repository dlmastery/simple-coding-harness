...
You are in **From a reply to an agent**. Start with [setup](../../START-HERE.md) if you opened this lesson directly. Previous: [Stage 2.3 - A read_file tool](../step_02_3_read_file/README.md). Next: [Stage 3 - Better UI](../step_03_better_ui/README.md).
