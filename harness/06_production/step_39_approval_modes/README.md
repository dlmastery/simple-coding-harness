...
You are in **Make a run inspectable**. Start with [setup](../../START-HERE.md) if you opened this lesson directly. Previous: [Step 38 - Capstone](../../05_recovery/step_38_capstone/README.md). Next: [Step 40 - Handoffs](../step_40_handoffs/README.md).
...
```bash
diff -r ../../05_recovery/step_38_capstone/harness harness
```
