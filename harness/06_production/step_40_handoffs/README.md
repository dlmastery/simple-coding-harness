...
You are in **Make a run inspectable**. Start with [setup](../../START-HERE.md) if you opened this lesson directly. Previous: [Step 39 - Approval modes](../step_39_approval_modes/README.md). Next: [Step 41 - Stop conditions](../step_41_stop_conditions/README.md).
...
What makes a handoff more than renaming the active agent?
...
Responsibility, the next action and required state must transfer under an explicit contract. Inspect what the receiving worker actually receives.
