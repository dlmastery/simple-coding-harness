...
WITHHELD = {"task", "browse", "write_todos", "str_replace", "write_file", "bash_background", "job_status", "job_wait", "job_kill", "computer_act", "computer_screenshot", "remember", "forget", "ask_user", "handoff_to"}  # and the conversation is the lead agent's to hand off
