...
You are in **Make a run inspectable**. Start with [setup](../../START-HERE.md) if you opened this lesson directly. Previous: [Step 41 - Stop conditions](../step_41_stop_conditions/README.md). Next: [Step 43 - Extensions](../step_43_extensions/README.md).
