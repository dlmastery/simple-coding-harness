...
What would violate a read-only planning stage?
...
A tool action that changes the protected workspace. A promise in prose is weaker than the actual tool restriction and observed behavior.
