...
Two tool calls write the same file. Does independence of their requests make parallel execution safe?
...
No. Their effects can conflict. Inspect dependencies and shared resources before overlapping them.
