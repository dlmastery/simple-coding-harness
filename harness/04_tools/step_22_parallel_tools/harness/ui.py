"""Step 22 - two guards for code that now runs on worker threads: APPROVE_LOCK
serialises the approval question, and working() hands a worker an Idle spinner
because rich allows one live display at a time.
"""
