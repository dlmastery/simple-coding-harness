...
You are in **Connect tools and observe the work**. Start with [setup](../../START-HERE.md) if you opened this lesson directly. Previous: [Step 20 - The same harness on OpenRouter](../../03_adapters/step_20_openrouter/README.md). Next: [Step 22 - Parallel tool calls](../step_22_parallel_tools/README.md).
