"""Step 31 - the system prompt carries the project instruction files.
...
SYSTEM_PROMPT is the prompt for the directory the harness started in. The
rest is step 30: PLAN_PROMPT and with_mode() are step 28; call_llm streams.
