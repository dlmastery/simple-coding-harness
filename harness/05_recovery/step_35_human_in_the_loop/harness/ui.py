"""Step 35 - the approve prompt takes four answers and returns the one
...
class UI:
    ...
    def banner(self, sandbox_name="none", mode="act"):
        ...
        self.console.print(Padding(Text(f"mode: {mode}  ·  sandbox: {sandbox_name}  ·  /plan  /act  /init  /sessions  /rewind  /undo  ·  alt-enter for a newline  ·  ctrl-c to steer  ·  ctrl-d (ctrl-z then enter on Windows), ctrl-c or /exit to leave", style=MUTED), (0, 0, 0, 2)))
