...
You are in **Resume work without guessing**. Start with [setup](../../START-HERE.md) if you opened this lesson directly. Previous: [Step 37 - Production harness anatomy](../step_37_production_anatomy/README.md). Next: [Step 39 - Approval modes](../../06_production/step_39_approval_modes/README.md).
...
```bash
cd harness/05_recovery/step_38_capstone
