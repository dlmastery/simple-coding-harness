...
You are in **Resume work without guessing**. Start with [setup](../../START-HERE.md) if you opened this lesson directly. Previous: [Step 33 - Workspace checkpoints and /undo](../step_33_checkpoints/README.md). Next: [Step 35 - Human in the loop](../step_35_human_in_the_loop/README.md).
