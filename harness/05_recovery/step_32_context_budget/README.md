...
You are in **Resume work without guessing**. Start with [setup](../../START-HERE.md) if you opened this lesson directly. Previous: [Step 31 - Project instruction files](../step_31_instruction_files/README.md). Next: [Step 33 - Workspace checkpoints and /undo](../step_33_checkpoints/README.md).
