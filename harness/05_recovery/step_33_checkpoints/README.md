...
You are in **Resume work without guessing**. Start with [setup](../../START-HERE.md) if you opened this lesson directly. Previous: [Step 32 - Context budget](../step_32_context_budget/README.md). Next: [Step 34 - Durability and recovery](../step_34_durability/README.md).
