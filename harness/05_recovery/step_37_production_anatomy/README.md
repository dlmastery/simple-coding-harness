...
You are in **Resume work without guessing**. Start with [setup](../../START-HERE.md) if you opened this lesson directly. Previous: [Step 36 - Orchestration patterns](../step_36_orchestration/README.md). Next: [Step 38 - Capstone](../step_38_capstone/README.md).
...
```bash
cd harness/05_recovery/step_37_production_anatomy
pip install -e .
harness
```
