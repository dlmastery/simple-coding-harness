"""Step 30 - eval_table() draws the result of an eval run: one row per
task with its pass rate, wall time, tokens, cost and the first line of the
last answer. It prints to stdout even in headless mode, where every other
panel goes to stderr. The rest is step 29.
"""
