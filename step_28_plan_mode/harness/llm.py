"""Step 28 - PLAN_PROMPT is the suffix the system prompt gets in plan mode;
with_mode() attaches it per request, so the transcript never carries it.
call_llm streams, as before.
