"""Step 28 - the late block names the mode in <env> and carries a <plan>
tag after <todos>: the plan-mode instructions while planning, the approved
plan while its todos are open, nothing otherwise.
"""
