# Generated wine harness

Ask your coding agent to read TASK.md, WORKFLOW.md, and RECOVERY.md, locate the recorded source clone, and run one declared recipe in a new output folder. The agent handles Python setup and commands. The run entry accepts run, compare, or final, plus repository and workspace paths. Task wine and a two-attempt limit are fixed in generated code.
