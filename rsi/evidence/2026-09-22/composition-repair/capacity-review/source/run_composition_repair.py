...
WORK = ROOT.parent / "rsi-work-2026-09-22-composition-repair-2"
...
def preflight():
    ...
    for kind in ("classification", "regression"):
        ...
        if kind == "classification":
            ...
            count_leaf = new(schema, kind, "base:extra-trees", 1.)
            fraction_leaf = clone(count_leaf).set_params(model__min_samples_leaf=1.)
            require("integer_count_not_fraction", signature(count_leaf) != signature(fraction_leaf))
