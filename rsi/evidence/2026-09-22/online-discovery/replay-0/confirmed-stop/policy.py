"""Agent-proposed revision 3: require a second candidate before the quality stop.
...
def choose(view):
    if len(view.observations) >= 2 and view.best_loss is not None and view.best_loss <= .20:
        return None
