...
Read the [checked development report](../../nested-research-development/README.md).
...
The earlier [six-procedure comparison](../../tabular-comparison/README.md)
is closed and remains visible. The next six datasets have
[checked source rows and grouping](../../nested-data/README.md).
