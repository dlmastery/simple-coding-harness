...
FIRST_FACTOR = 0.5
BREADTH = 2
RANKING = {'classification': ['base:linear', 'two:forest-all-features', 'base:rbf-10', 'one:rbf-wide', 'one:boost-regularized', 'base:extra-trees', 'base:rbf-1', 'two:unscaled-c100', 'one:rbf-unscaled', 'base:random-forest', 'two:native-category-boost', 'base:neighbors-25', 'base:neighbors-5', 'two:unscaled-c1', 'one:extra-leaf2'], 'regression': ['base:extra-trees', 'base:hist-boost', 'two:extra-leaf5', 'one:absolute-boost', 'base:random-forest', 'base:rbf-10', 'two:quadratic-splines', 'base:neighbors-5', 'two:log-svr', 'one:svr-tight', 'one:absolute-forest', 'two:log-boost', 'base:linear']}
PREFIX = {
