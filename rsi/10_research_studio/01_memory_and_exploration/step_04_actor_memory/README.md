...
**A concrete example.** The [executed outcome-and-memory activity](../../../evidence/2026-09-21/memory-labs/README.md#outcome-and-lesson) checked exploration MAE 99.175924. The actor then wrote a bounded residual-inspection lesson. A separate overbroad draft said always to use the winning linear model; an existing classification case preferred its tree child, 0.88 versus 0.86 balanced accuracy. The checked regression score was valid, but it could not establish a universal model preference. The later [96-outcome experience pool](../../../evidence/2026-09-22/tabular-memory/README.md) preserves checked development outcomes and an actor-authored interpretation. The numerical verifier does not certify the generalizations in MEMORY.md. Its frozen ranks supply an executable retrieval interface for the subsequent task comparison.
