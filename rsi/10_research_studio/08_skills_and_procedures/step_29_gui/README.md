...
Open the coding agent at the repository root. Read [the tutor skill](../../../skills/rsi-tutor/SKILL.md) and this lab's [brief](BRIEF.md). The agent keeps this lab's notes in <code>rsi-work/10-29</code>, outside the repository, and reports the absolute path. If the lab continues an earlier experiment, keep that experiment in its original workspace with its existing budget and locks. A new notes folder does not reset an experiment. The agent checks local Python and the [tool requirements](../../../tools/README.md) before execution. You do not write code or configuration.
...
**A concrete example.** In the [two recorded browser attempts](../../../evidence/2026-09-21/gui-skill/README.md), candidate A has a real MAE of 73.69, but its detail view reveals a smaller evaluation subset. It is ineligible for the requested full comparison. A deliberately deficient skill selects A and fails. After one instruction revision, the actor opens the details and selects eligible B at 98.03. The page is unchanged; the shared author context prevents a claim of independent skill discovery.
