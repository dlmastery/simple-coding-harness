...
**You are here:** Theme 10, Research studio → lab 14 of 38. [Find this theme in the course map](../../../COURSE-MAP.md#theme-10) · [Whole-course mindmap](../../../COURSE-MAP.md#whole-course-mindmap).
...
Open the coding agent at the repository root. Read [the tutor skill](../../../skills/rsi-tutor/SKILL.md) and this lab's [brief](BRIEF.md). The agent keeps this lab's notes in <code>rsi-work/10-14</code>, outside the repository, and reports the absolute path. If the lab continues an earlier experiment, keep that experiment in its original workspace with its existing budget and locks. A new notes folder does not reset an experiment. The agent checks local Python and the [tool requirements](../../../tools/README.md) before execution. You do not write code or configuration.
...
**A concrete example.** In the [recorded matched comparison](../../../evidence/2026-09-21/aide-labs/README.md), the child moves the weather-input change ahead of the tree probe. Each researcher spends three fits. The parent retains selection MAE 109.81; the child retains 99.18. The earlier four-fit trace motivated this edit and belongs in its discovery cost. This exposed-data result measures one procedure change, not ignition or equal total research cost. The broader [reserved-task comparison](../../../evidence/2026-09-22/tabular-comparison/README.md) gives original and revised harnesses the same updater and eight attempts. The revised harness improves one final task, ties four and worsens one; the mean change is uncertain. Its source changes and later execution are real, but they do not establish that the harness revision is beneficial or that ignition occurred. The [complete-researcher extension](../../../evidence/2026-09-22/nested-research-evaluation/README.md) evaluates executable search loops, including feedback-dependent allocation and parent selection. Its 624 attempts include losing development searches and final scoring. Later generated researchers really run, but their quality advantage remains inconclusive. The rewrite space is bounded; this is not a full AIDE2 reproduction or ignition result.
