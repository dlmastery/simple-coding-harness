...
Prediction to ask: Should a data pass for candidate A combine with a budget pass for candidate B?

Execution limit: No model fits; four join scenarios.
...
Acceptance: The join rejects mismatched candidate identities, mismatched contract versions, and incomplete evidence. The report states whether checks ran sequentially or concurrently.
