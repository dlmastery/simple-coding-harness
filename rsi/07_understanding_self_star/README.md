...
Each lab changes one property of the same small research workflow. Ask what persists and what observation would establish a benefit.
...
| [07.03 · Retain and use a lesson](step_03_persistent_learning/README.md) | A versioned memory note that changes a later decision. |
