...
- fit_recipe - one fit (or a list) on train scored on val; counted against the budget of 24
- score_test - the locked test split, once, after FREEZE
- save_model - pickle the chosen recipe's fitted pipeline
- scorecard - the numbers of this arm, the fields of lesson 00's acceptance.md
