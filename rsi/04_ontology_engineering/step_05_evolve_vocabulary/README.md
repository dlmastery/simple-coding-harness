...
**You are here:** Theme 04, Dependable workflows → lab 5 of 5. [Find this theme in the course map](../../COURSE-MAP.md#theme-04) · [Whole-course mindmap](../../COURSE-MAP.md#whole-course-mindmap).
...
Open the coding agent at the repository root. Read [the tutor skill](../../skills/rsi-tutor/SKILL.md) and this lab's [brief](BRIEF.md). The agent keeps this lab's notes in <code>rsi-work/04-05</code>, outside the repository, and reports the absolute path. If the lab continues an earlier experiment, keep that experiment in its original workspace with its existing budget and locks. A new notes folder does not reset an experiment. The agent checks local Python and the [tool requirements](../../tools/README.md) before execution. You do not write code or configuration.
...
**A concrete example.** In the [executed synthetic availability cases](../../evidence/2026-09-22/ontology-system/04-05/AVAILABILITY.csv), a prediction is issued at noon today for noon tomorrow. A forecast released at 09:00 today passes the time rule; tomorrow’s observed weather and an unknown release time are refused. This does not create the missing real forecast archive. The [wine extension](../../evidence/2026-09-22/ontology-system/04-05/WINE-ORDINAL.md) applies the same reasoning to a new target: predicting an ordered rating needs different labels, metric choices and evidence from binary classification.
