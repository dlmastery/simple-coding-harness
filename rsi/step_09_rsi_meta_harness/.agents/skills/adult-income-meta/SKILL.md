...
`.claude/skills/adult-income-meta` (`M`); the target is the actor pack `.claude/skills/adult-income`
...
## Done when
`apply` answered (landed or rejected), or there was nothing to propose.
