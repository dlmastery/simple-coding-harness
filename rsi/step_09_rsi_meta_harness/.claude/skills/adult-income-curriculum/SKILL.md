...
`.claude/skills/adult-income-verifier` (`V`); the meta pack is the one the user names -
`.claude/skills/adult-income-meta` (approval: human) or `.claude/skills/adult-income-meta-gate`
(approval: gate) - (`M`); the curriculum is `../tasks/01_adult_income` ..
