...
name: pool_trees_2
index: 2
title: "Pool table 2 (three clusters per class, another seed)"
role: pool
target: target
metric: roc_auc
budget_fits: 24
...
---
# Intent: Pool table 2 (three clusters per class, another seed)

## What to improve
ROC-AUC on the second pool table, same shape, another seed.

## Why
Two pool problems let `contrast` pair a success and a failure more than once before it names a module.
