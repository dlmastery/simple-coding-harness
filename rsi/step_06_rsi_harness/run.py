...
MEMORY_OFF arm at the same budget.
    ...
    FAKE_MODEL=1 python run.py                       # the four small curriculum problems, both arms
...
DEFAULT = ("breast_cancer", "wine", "synth_shift_a", "synth_shift_b")   # the four small problems: cards accumulate fast
...
def main(names):
    ...
    problems = [tasks.load_task(n) for n in names or DEFAULT]
