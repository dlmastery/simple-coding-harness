...
## Allowed
- load_splits, fit_recipe, score_test, scorecard - the actor's tools, run as the actor pack on each arm
- write_plan, read_memory - the planner's tools, run for the planner pack before each phase
