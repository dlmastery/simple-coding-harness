...
from harness import agent, commands, context, hooks, jobs, permissions, plan, session, subagent, tools  # noqa: E402
...
def test_one_description_still_runs_one_subagent(quiet, monkeypatch):
    ...
    assert schema["anyOf"] == [{"required": ["description"]}, {"required": ["descriptions"]}]
