...
class UI:
    ...
    def banner(self, sandbox_name="none"):
        ...
        self.console.print(Padding(Text(f"sandbox: {sandbox_name}  ·  /sessions  /rewind  ·  ctrl-d (ctrl-z then enter on Windows), ctrl-c or /exit to leave", style=MUTED), (0, 0, 0, 2)))
